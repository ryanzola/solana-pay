...
console.log("Creating the token account for the shop...")
...
console.log("Minting 1 million token coupons to the ship account...")
await mintToChecked(
  connection,
  shopAccount,        // payer
  myCouponAddress,    // token
...
console.log("Minted 1 million couplons to the shop account")
